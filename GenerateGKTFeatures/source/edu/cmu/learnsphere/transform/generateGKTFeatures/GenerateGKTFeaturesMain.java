package edu.cmu.learnsphere.transform.generateGKTFeatures;
 ...
 */
public class GenerateGKTFeaturesMain extends AbstractComponent {
    ...
    public static void main(String[] args) {
        ...
        GenerateGKTFeaturesMain tool = new GenerateGKTFeaturesMain();
     ...
     * Constructor.
     */
    public GenerateGKTFeaturesMain() {
        super();
    }
	...
	File outputFile0 = new File(outputDirectory.getAbsolutePath() + "/GKT.txt");
