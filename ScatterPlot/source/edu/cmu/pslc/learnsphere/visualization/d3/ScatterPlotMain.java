...
public class ScatterPlotMain extends AbstractComponent {
    ...
    public static void main(String[] args) {
        ScatterPlotMain tool = new ScatterPlotMain();
        tool.startComponent(args);
    }

    /**
     * This class runs the ScatterPlot one or more times
     * depending on the number of input elements.
     */
    public ScatterPlotMain() {
        super();
    }
    ...
    protected void runComponent() {
        ...
        File htmlTemplateFile = new File(this.getToolDir() + "/program/ScatterPlot.html");
        if (inputFile.exists() && inputFile.isFile() && inputFile.canRead()
                && htmlTemplateFile.exists() && htmlTemplateFile.isFile() && htmlTemplateFile.canRead()) {
            File outputFile = this.createFile("ScatterPlotVisualization.html");
