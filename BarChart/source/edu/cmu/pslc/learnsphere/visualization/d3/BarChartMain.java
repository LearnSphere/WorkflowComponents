...
public class BarChartMain extends AbstractComponent {
    ...
    public static void main(String[] args) {
        BarChartMain tool = new BarChartMain();
        tool.startComponent(args);
    }

    /**
     * This class runs the BarChart one or more times
    ...
    protected void runComponent() {
        ...
        File htmlTemplateFile = new File(this.getToolDir() + "/program/BarChart.html");
        if (inputFile.exists() && inputFile.isFile() && inputFile.canRead()
                && htmlTemplateFile.exists() && htmlTemplateFile.isFile() && htmlTemplateFile.canRead()) {
            File outputFile = this.createFile("BarChartVisualization.html");
