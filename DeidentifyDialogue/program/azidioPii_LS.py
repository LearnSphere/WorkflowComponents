...
#hips yes, skip no, csv, presidio, encoding no
#C:\Users\hchen\Anaconda3\python.exe azidioPii_LS.py -programDir . -workingDir . -userId hcheng -Hash_col_nodeIndex 1 -Hash_col_fileIndex 0 -Hash_col name -Hips_boolean Yes -method Presidio -name_col_nodeIndex 1 -name_col_fileIndex 0 -name_col name -piiFileType CSV -skipCol No -skip_columns_nodeIndex 0 -skip_columns_fileIndex 0 -skip_columns name -skip_columns_nodeIndex 0 -skip_columns_fileIndex 0 -skip_columns email -useEncoding No -node 0 -fileIndex 0 csv_file_test.csv -node 1 -fileIndex 0 updated_encoding_file.csv
#hips no, skip yes, csv, presidio, encoding yes
#C:\Users\hchen\Anaconda3\python.exe azidioPii_LS.py -programDir . -workingDir . -userId hcheng -Hash_col_nodeIndex 1 -Hash_col_fileIndex 0 -Hash_col hash -Hips_boolean No -method Presidio -name_col_nodeIndex 1 -name_col_fileIndex 0 -name_col name -piiFileType CSV -skipCol Yes -skip_columns_nodeIndex 0 -skip_columns_fileIndex 0 -skip_columns name -skip_columns_nodeIndex 0 -skip_columns_fileIndex 0 -skip_columns email -useEncoding Yes -node 0 -fileIndex 0 csv_file_test.csv -node 1 -fileIndex 0 updated_encoding_file.csv
#config file, hips no, azure, noncsv, skip no
#C:\Users\hchen\Anaconda3\python.exe azidioPii_LS.py -programDir . -workingDir . -userId hcheng -Hips_boolean No -method Azure -piiFileType Non-CSV -skipCol No -useEncoding No -use_config Yes -node 0 -fileIndex 0 random_transcript.json -node 2 -fileIndex 0 config_file.txt
#command line
command_line = True
if command_line:
