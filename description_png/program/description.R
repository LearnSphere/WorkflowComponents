...
#for(i in(1:length(output))){
  ...
  png( sprintf("%s/output0.png",workingDirectory))
  output[[1]]
  dev.off()
  options(bitmapType='cairo')
  png( sprintf("%s/output1.png",workingDirectory))
  output[[2]]
  dev.off()
  options(bitmapType='cairo')
  png( sprintf("%s/output2.png",workingDirectory))
  output[[3]]
  dev.off()
  options(bitmapType='cairo')
  png( sprintf("%s/output3.png",workingDirectory))
  output[[4]]
  dev.off()
