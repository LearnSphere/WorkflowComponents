 ...
 */
public class CompareModelScoresMain extends AbstractComponent {
    ...
    public static void main(String[] args) {
        ...
        CompareModelScoresMain tool = new CompareModelScoresMain();
	...
	this.addMetaDataFromInput("model-scores", 0, 0, ".*");
