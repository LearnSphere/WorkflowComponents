package edu.cmu.pslc.learnsphere.transform.AnalysisGeneralLR;

import java.io.File;

import edu.cmu.pslc.datashop.workflows.AbstractComponent;

public class AnalysisGeneralLRMain extends AbstractComponent {


    public static void main(String[] args) {

        AnalysisGeneralLRMain tool = new AnalysisGeneralLRMain();
        tool.startComponent(args);
    }

    public AnalysisGeneralLRMain() {
        super();
    }
    ...
    protected void runComponent() {
        ...
        if (outputDirectory.isDirectory() && outputDirectory.canRead()) {
            File outputFile = new File(outputDirectory.getAbsoluteFile() + "/AnalysisGeneralLR Datashop.txt");
