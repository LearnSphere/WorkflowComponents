...
echo -e "\t'1.0', " >> $out_file
echo -e "\t'Allow user to manually specify the rank of a model from an ordered list of ranked models'" >> $out_file
echo -e ");" >> $out_file
