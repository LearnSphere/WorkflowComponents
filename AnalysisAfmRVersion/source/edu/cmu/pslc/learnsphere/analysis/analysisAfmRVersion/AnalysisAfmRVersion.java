package edu.cmu.pslc.learnsphere.analysis.analysisAfmRVersion;
...
public class AnalysisAfmRVersion extends AbstractComponent {
    ...
    public static void main(String[] args) {
    	...
    	AnalysisAfmRVersion tool = new AnalysisAfmRVersion();
        tool.startComponent(args);
    }

    public AnalysisAfmRVersion() {
        super();
    }
    ...
    protected void runComponent() {
        ...
        logger.info("AFM inputFile: " + inputFile.getAbsolutePath());
