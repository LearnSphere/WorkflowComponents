...
public class HistogramMain extends AbstractComponent {
    ...
    public static void main(String[] args) {
        HistogramMain tool = new HistogramMain();
        tool.startComponent(args);
    }

    /**
     * This class runs the Histogram one or more times
    ...
    protected void runComponent() {
        ...
        File htmlTemplateFile = new File(this.getToolDir() + "/program/Histogram.html");
        if (inputFile.exists() && inputFile.isFile() && inputFile.canRead()
                && htmlTemplateFile.exists() && htmlTemplateFile.isFile() && htmlTemplateFile.canRead()) {
            File outputFile = this.createFile("histogramVisualization.html");
