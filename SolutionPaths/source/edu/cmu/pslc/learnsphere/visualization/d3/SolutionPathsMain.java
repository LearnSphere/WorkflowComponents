...
public class SolutionPathsMain extends AbstractComponent {
    ...
    public static void main(String[] args) {
        SolutionPathsMain tool = new SolutionPathsMain();
        tool.startComponent(args);
    }

    /**
     * This class runs the SolutionPaths one or more times
     * depending on the number of input elements.
     */
    public SolutionPathsMain() {
        super();
    }
    ...
    protected void runComponent() {
        ...
        File htmlTemplateFile = new File(this.getToolDir() + "/program/SolutionPaths.html");
        if (inputFile.exists() && inputFile.isFile() && inputFile.canRead()
                && htmlTemplateFile.exists() && htmlTemplateFile.isFile() && htmlTemplateFile.canRead()) {
            File outputFile = this.createFile("SolutionPathsVisualization.html");
