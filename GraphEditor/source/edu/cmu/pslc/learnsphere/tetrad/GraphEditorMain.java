...
public class GraphEditorMain extends AbstractComponent {
    ...
    public static void main(String[] args) {
        ...
        GraphEditorMain tool = new GraphEditorMain();
    ...
    private void addErrorsAndDebugsToLogger(String outputPath) {
        ...
        for (int i = 0; i < errors.size(); i++) {
            errorMessages.add("[error from GraphEditor.java] " + errors.get(i));
        }

        ArrayList<String> debugMessages = getDebugMessagesFromComponent(outputPath);
        for (int i = 0; i < debugMessages.size(); i++) {
            logger.debug("[debug from GraphEditor.java] " + debugMessages.get(i));
        }
