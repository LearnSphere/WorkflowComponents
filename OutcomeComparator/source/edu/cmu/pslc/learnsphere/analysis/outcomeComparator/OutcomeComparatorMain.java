package edu.cmu.pslc.learnsphere.analysis.outcomeComparator;
...
public class OutcomeComparatorMain extends AbstractComponent {

    public static void main(String[] args) {

        OutcomeComparatorMain tool = new OutcomeComparatorMain();
        tool.startComponent(args);
    }

    public OutcomeComparatorMain() {
        super();
    }
