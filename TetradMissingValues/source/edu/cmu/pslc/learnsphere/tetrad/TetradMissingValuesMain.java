...
//import edu.cmu.TetradHelper.TetradComponent;

public class TetradMissingValuesMain extends AbstractComponent {
    ...
    public static void main(String[] args) {
        ...
        TetradMissingValuesMain tool = new TetradMissingValuesMain();
     ...
     */
    public TetradMissingValuesMain() {
        super();
    }
    @Override
    protected void runComponent() {
        ...
        if (outputDirectory.isDirectory() && outputDirectory.canRead()) {
            File file0 = new File(outputDirectory.getAbsolutePath() + "/ManipulatedData.txt");
