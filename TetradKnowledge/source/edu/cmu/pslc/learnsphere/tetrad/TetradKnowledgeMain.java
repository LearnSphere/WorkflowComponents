...
public class TetradKnowledgeMain extends AbstractComponent {
    ...
    public static void main(String[] args) throws IOException {
        ...
        TetradKnowledgeMain tool = new TetradKnowledgeMain();
    ...
    protected void runComponent() {
        ...
        if (outputDirectory.isDirectory() && outputDirectory.canRead()) {
            ...
            if (file0 != null && file0.exists()) {
                ...
                errorMessages.add("cannot add output file");
            }
        } else {
    ...
    private void addErrorsAndDebugsToLogger(String outputPath) {
        ...
        for (int i = 0; i < errors.size(); i++) {
            errorMessages.add("[error from TetradKnowledge.java] " + errors.get(i));
        }

        ArrayList<String> debugMessages = getDebugMessagesFromComponent(outputPath);
        for (int i = 0; i < debugMessages.size(); i++) {
            logger.debug("[debug from TetradKnowledge.java] " + debugMessages.get(i));
        }
