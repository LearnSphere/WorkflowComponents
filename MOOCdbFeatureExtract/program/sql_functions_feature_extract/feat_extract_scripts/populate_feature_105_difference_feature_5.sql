...
SELECT @feature_extraction_id, 105,
	features.user_id,
...
WHERE
	...
	AND features.longitudinal_feature_id = 5 AND features.feature_extraction_id = @feature_extraction_id
	AND features2.longitudinal_feature_id = 5 AND features2.feature_extraction_id = @feature_extraction_id
