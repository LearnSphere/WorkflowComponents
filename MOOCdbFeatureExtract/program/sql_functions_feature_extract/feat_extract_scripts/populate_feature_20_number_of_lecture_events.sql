...
-- Feature 20: total count of video/lecture related observed events - during the week
...
SELECT @feature_extraction_id,20,
	users.user_id,
...
WHERE users.user_dropout_week IS NOT NULL
	-- for visit_tutorial
	AND observed_events.observed_event_type_id = 2
