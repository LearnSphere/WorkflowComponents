...
public class TetradDiscretizeMain extends AbstractComponent {
    ...
    public static void main(String[] args) {
        ...
        TetradDiscretizeMain tool = new TetradDiscretizeMain();
    ...
    private void addErrorsAndDebugsToLogger(String outputPath) {
        ...
        for (int i = 0; i < errors.size(); i++) {
            errorMessages.add("[error from TetradDiscretize.java] " + errors.get(i));
        }

        ArrayList<String> debugMessages = getDebugMessagesFromComponent(outputPath);
        for (int i = 0; i < debugMessages.size(); i++) {
            logger.debug("[debug from TetradDiscretize.java] " + debugMessages.get(i));
        }
