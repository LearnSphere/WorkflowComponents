#usage
#"C:\Program Files\R\R-3.2.2\bin\Rscript.exe" R_GLM.R -node 0 -fileIndex 0 data.txt -modelingFunc "glm" -formula "Final_Exam~Video" -family "quasi(link=identity, variance=constant)" -workingDir "." -programDir "."
#"C:\Program Files\R\R-3.2.2\bin\Rscript.exe" R_GLM.R -node 0 -fileIndex 0 data.txt -modelingFunc "glm" -formula "Final_Exam~Video" -family "binomial" -workingDir "." -programDir "."
